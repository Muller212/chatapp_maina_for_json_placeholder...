...
class _ChatDetailPageState extends State<ChatDetailPage> {
  List<ChatMessage> chatMessage = [
    ChatMessage(message: "We Muller", type: MessageType.Receiver),
    ChatMessage(message: "Hope you are doin good?", type: MessageType.Receiver),
    ChatMessage(message: "We Mzee, I'm good what about you", type: MessageType.Sender),
    ChatMessage(message: "I'm fine, Working from home", type: MessageType.Receiver),
    ChatMessage(message: "Sema tu ni shugli za wash wash", type: MessageType.Sender),
  ];
